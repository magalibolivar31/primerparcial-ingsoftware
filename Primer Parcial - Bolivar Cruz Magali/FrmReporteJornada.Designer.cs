namespace GUI
{
    partial class FrmReporteJornada
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblSelectedSub   = new System.Windows.Forms.Label();
            ...
            this.grpFiltros.Size     = new System.Drawing.Size(1185, 100);
            this.grpFiltros.Anchor   = System.Windows.Forms.AnchorStyles.Top
                                     | System.Windows.Forms.AnchorStyles.Left
                                     | System.Windows.Forms.AnchorStyles.Right;

            // Fila 1: combos + checkBox + botones de acción
            this.lblEstado.Text      = "Estado:";
            this.lblEstado.Font      = boldFont;
            this.lblEstado.Location  = new System.Drawing.Point(10, 28);
            this.lblEstado.Size      = new System.Drawing.Size(55, 20);
            this.lblEstado.TextAlign = System.Drawing.ContentAlignment.MiddleRight;

            this.cboEstado.Font          = normFont;
            this.cboEstado.Location      = new System.Drawing.Point(70, 26);
            ...
            this.lblTipo.Location  = new System.Drawing.Point(228, 28);
            ...
            this.cboTipo.Location      = new System.Drawing.Point(273, 26);
            ...
            this.chkSoloRaiz.Location = new System.Drawing.Point(423, 27);
            this.chkSoloRaiz.Size     = new System.Drawing.Size(140, 22);
            ...
            this.btnGenerar.Location  = new System.Drawing.Point(575, 24);
            ...
            // Fila 2: exportar + imprimir + conteo
            ...
            this.btnExportarPDF.Location  = new System.Drawing.Point(10, 62);
            this.btnExportarPDF.Size      = new System.Drawing.Size(100, 26);
            this.btnExportarPDF.Click    += new System.EventHandler(this.btnExportarPDF_Click);

            this.btnExportarExcel.Text      = "Exportar Excel";
            this.btnExportarExcel.Font      = normFont;
            this.btnExportarExcel.BackColor = System.Drawing.Color.FromArgb(30, 130, 70);
            this.btnExportarExcel.ForeColor = System.Drawing.Color.White;
            this.btnExportarExcel.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
            this.btnExportarExcel.FlatAppearance.BorderSize = 0;
            this.btnExportarExcel.Location  = new System.Drawing.Point(120, 62);
            this.btnExportarExcel.Size      = new System.Drawing.Size(110, 26);
            this.btnExportarExcel.Click    += new System.EventHandler(this.btnExportarExcel_Click);

            this.btnImprimir.Text      = "Imprimir";
            this.btnImprimir.Font      = normFont;
            this.btnImprimir.BackColor = System.Drawing.Color.FromArgb(80, 80, 160);
            this.btnImprimir.ForeColor = System.Drawing.Color.White;
            this.btnImprimir.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
            this.btnImprimir.FlatAppearance.BorderSize = 0;
            this.btnImprimir.Location  = new System.Drawing.Point(240, 62);
            ...
            this.lblConteo.Location  = new System.Drawing.Point(340, 66);
            this.lblConteo.Size      = new System.Drawing.Size(440, 18);
            this.lblConteo.Text      = "";
            ...
            this.grpFiltros.Controls.AddRange(new System.Windows.Forms.Control[] {
                ...
                this.chkSoloRaiz,
                this.btnGenerar, this.btnLimpiar,
                this.btnExportarPDF, this.btnExportarExcel, this.btnImprimir,
                this.lblConteo
            });

            // ── pnlTotales — 4 tarjetas de métricas ───────────────────────────
            this.pnlTotales.Location  = new System.Drawing.Point(5, 110);
            ...
            // Tarjeta 1: Total Ítems
            this.pnlCard1.Location  = new System.Drawing.Point(5, 4);
            this.pnlCard1.Size      = new System.Drawing.Size(215, 64);
            ...
            this.lblTotalItems.Size      = new System.Drawing.Size(200, 38);

            this.pnlCard1.Controls.AddRange(new System.Windows.Forms.Control[] {
                this.lblTitleCard1, this.lblTotalItems
            });

            // Tarjeta 2: Adjudicados
            this.pnlCard2.Location  = new System.Drawing.Point(225, 4);
            this.pnlCard2.Size      = new System.Drawing.Size(215, 64);
            ...
            this.lblAdjudicados.Size      = new System.Drawing.Size(200, 38);
            ...
            // Tarjeta 3: Desiertos
            this.pnlCard3.Location  = new System.Drawing.Point(445, 4);
            this.pnlCard3.Size      = new System.Drawing.Size(215, 64);
            ...
            this.lblDesiertos.Size      = new System.Drawing.Size(200, 38);

            this.pnlCard3.Controls.AddRange(new System.Windows.Forms.Control[] {
                this.lblTitleCard3, this.lblDesiertos
            });

            // Tarjeta 4: Monto Recaudado
            this.pnlCard4.Location  = new System.Drawing.Point(665, 4);
            this.pnlCard4.Size      = new System.Drawing.Size(260, 64);
            ...
            this.lblMontoRecaudado.Size      = new System.Drawing.Size(248, 38);
            ...
            this.pnlTotales.Controls.AddRange(new System.Windows.Forms.Control[] {
                this.pnlCard1, this.pnlCard2, this.pnlCard3, this.pnlCard4
            });

            // ── grpCatalogo ────────────────────────────────────────────────────
            this.grpCatalogo.Text     = "Catálogo — Unidades de Venta";
            this.grpCatalogo.Font     = boldFont;
            this.grpCatalogo.Location = new System.Drawing.Point(5, 187);
            this.grpCatalogo.Size     = new System.Drawing.Size(1185, 270);
            this.grpCatalogo.Anchor   = System.Windows.Forms.AnchorStyles.Top
                                      | System.Windows.Forms.AnchorStyles.Left
                                      | System.Windows.Forms.AnchorStyles.Right;

            this.dgvCatalogo.Location            = new System.Drawing.Point(8, 20);
            this.dgvCatalogo.Size                = new System.Drawing.Size(1167, 240);
            this.dgvCatalogo.Anchor              = System.Windows.Forms.AnchorStyles.Top
                                                 | System.Windows.Forms.AnchorStyles.Left
                                                 | System.Windows.Forms.AnchorStyles.Right;
            this.dgvCatalogo.ReadOnly            = true;
            this.dgvCatalogo.Font                = new System.Drawing.Font("Segoe UI", 9.5F);
            this.dgvCatalogo.AutoGenerateColumns = false;
            this.dgvCatalogo.SelectionChanged   += new System.EventHandler(this.dgvCatalogo_SelectionChanged);

            this.grpCatalogo.Controls.Add(this.dgvCatalogo);

            // ── grpOfertas ─────────────────────────────────────────────────────
            this.grpOfertas.Text     = "Ofertas";
            this.grpOfertas.Font     = boldFont;
            this.grpOfertas.Location = new System.Drawing.Point(5, 462);
            this.grpOfertas.Size     = new System.Drawing.Size(1185, 388);
            this.grpOfertas.Anchor   = System.Windows.Forms.AnchorStyles.Top
                                     | System.Windows.Forms.AnchorStyles.Left
                                     | System.Windows.Forms.AnchorStyles.Right
                                     | System.Windows.Forms.AnchorStyles.Bottom;

            this.lblSelectedTitle.Text      = "  Seleccione un elemento del catálogo para ver sus ofertas";
            this.lblSelectedTitle.Font      = new System.Drawing.Font("Segoe UI", 10F, System.Drawing.FontStyle.Bold);
            this.lblSelectedTitle.ForeColor = darkNavy;
            this.lblSelectedTitle.Location  = new System.Drawing.Point(8, 20);
            this.lblSelectedTitle.Size      = new System.Drawing.Size(1100, 22);
            this.lblSelectedTitle.Anchor    = System.Windows.Forms.AnchorStyles.Top
                                            | System.Windows.Forms.AnchorStyles.Left
                                            | System.Windows.Forms.AnchorStyles.Right;

            this.lblSelectedSub.Text      = "";
            this.lblSelectedSub.Font      = new System.Drawing.Font("Segoe UI", 8.5F, System.Drawing.FontStyle.Italic);
            this.lblSelectedSub.ForeColor = System.Drawing.Color.DimGray;
            this.lblSelectedSub.Location  = new System.Drawing.Point(8, 44);
            this.lblSelectedSub.Size      = new System.Drawing.Size(1100, 18);
            this.lblSelectedSub.Anchor    = System.Windows.Forms.AnchorStyles.Top
                                          | System.Windows.Forms.AnchorStyles.Left
                                          | System.Windows.Forms.AnchorStyles.Right;

            this.dgvPujas.Location            = new System.Drawing.Point(8, 66);
            this.dgvPujas.Size                = new System.Drawing.Size(1167, 312);
            this.dgvPujas.Anchor              = System.Windows.Forms.AnchorStyles.Top
                                              | System.Windows.Forms.AnchorStyles.Left
                                              | System.Windows.Forms.AnchorStyles.Right
                                              | System.Windows.Forms.AnchorStyles.Bottom;
            this.dgvPujas.ReadOnly            = true;
            this.dgvPujas.Font                = new System.Drawing.Font("Segoe UI", 9.5F);
            this.dgvPujas.AutoGenerateColumns = false;

            this.grpOfertas.Controls.AddRange(new System.Windows.Forms.Control[] {
                this.lblSelectedTitle, this.lblSelectedSub, this.dgvPujas
            });
            ...
            this.Text          = "Reporte de Jornada — Catálogo Completo (RF-13)";
        ...
        private System.Windows.Forms.Label                 lblSelectedSub;
